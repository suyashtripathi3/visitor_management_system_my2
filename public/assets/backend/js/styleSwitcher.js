...
function addSwitcher(){
    ...
    <div class="sidebar-right-inner">
        ...
        <div class="tab-content tab-content-default tabcontent-border">
            ...
            <div class="note-text">
				<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/?theme=yashadmin" target="_blank">documentation.</a>
			</div>
        </div>
	</div>
</div>`;
    ...
    <div class="dz-demo-inner">
        ...
        <div class="fs-14 pt-3">
			<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/basic/overview.html" target="_blank" class="text-primary">documentation.</a>
		</div>
    </div>
</div>`;
