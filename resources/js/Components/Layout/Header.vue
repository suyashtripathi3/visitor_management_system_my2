...
<template>
    ...
    <div class="nav-header">
        <a :href="AppRoutes.dashboard" class="brand-logo">
            ...
            <svg class="brand-title" width="111" height="24" viewBox="0 0 111 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <rect class="yesh" width="49" height="22" transform="translate(0 1)" fill="var(--bs-primary)" />
                <path class="admin1"
                ...
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right align-items-center">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <div class="dropdown">
                                <button class="nav-link bg-white rounded-3 mx-1" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false" aria-label="Notification Dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end py-0">
                                    ...
                                    <a class="d-block text-center p-3 border-top" href="javascript:void(0);">See all
                                        notifications <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item notification_dropdown">
                            <a class="nav-link btn-chatbox bg-white rounded-3 mx-1" href="javascript:void(0);"
                                aria-label="Sidabar Chatbox">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item dropdown header-profile-dropdown">
                            <a class="nav-item ps-3 p-0" href="javascript:void(0);" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="profile-head">
                                    <div class="avatar avatar-sm border-0">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="app-profile.html">
                                        ...
                                        <span
                                            class="badge badge-sm badge-primary light rounded-circle float-end">4</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="page-login.html" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none" stroke="var(--bs-danger)" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round">
